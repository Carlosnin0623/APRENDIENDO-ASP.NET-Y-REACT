export default function Paginacion(props: PaginacionProps) {
    ...
    const totalPaginas = Math.ceil(props.cantidadTotalRgistros / props.registrosPorPagina);
                        ...
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <select
                                ...
                                onChange={e => props.onCambioPaginacion(1, parseInt(e.target.value, 10))}>
                                 ...
                                 {props.registroPorPaginaOpciones.map(opcion => <option key={opcion}>{opcion}</option> )}
                    ...
                    <div className="col">
                        <ul className="pagination justify-content-center mb-0">
                            <li className={`page-item ${props.paginaActual === 1 ? 'disabled' : ''}`}>
                                <button className="page-link" onClick={() => props.onCambioPaginacion(props.paginaActual - 1, props.registrosPorPagina)}>
                                    &laquo;
                                </button>
                            </li>
